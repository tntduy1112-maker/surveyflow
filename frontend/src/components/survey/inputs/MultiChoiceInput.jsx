...
export default function MultiChoiceInput({ question }) {
  const { isSelected, toggleMultiple, others, setOther } = useSurveyStore()
  const otherSelected = isSelected(question.id, '__other__')

  return (
    <div className="flex flex-col gap-2">
      <div className="text-[12px] text-gray-dark bg-gray-bg border border-gray-border rounded px-2 py-1 inline-self-start w-fit mb-1">
